      ...
      <form id="fr1" action="#" method="post" autocomplete="off">
        ...
        <div class="modal-body">
          <div class="row mb-2">
            ...
            <div class="col-lg-4"><input type="number" name="mdfr-in1" id="mdfr-in1" class="form-control"></div>
          </div>
          <div class="row mb-2">
            <label for="mdfr-in2" class="col-lg-4 label-fr">Nama Tahun Akademik :</label>
            <div class="col-lg"><input type="text" name="mdfr-in2" id="mdfr-in2" class="form-control"></div>
          </div>
          <div class="row mb-2">
            <label for="mdfr-in3" class="col-lg-4 label-fr">Nama Singkat :</label>
            <div class="col-lg-5"><input type="text" name="mdfr-in3" id="mdfr-in3" class="form-control"></div>
          </div>
          <div class="row mb-2">
...
<script>
  ...
  $('#fr1').submit(function(e){
    ...
    const datas = {'_token':token,'act':act,'in1':$('#mdfr-in1').val(),'in2':$('#mdfr-in2').val(),'in3':$('#mdfr-in3').val(),'in4':($('#mdfr-in4').is(':checked')) ? 'Y' : 'T'};
    const bid = $('#mdfr-btn');
    const bval = bid.html();
    $.ajax({
    ...
    if (state == 'edit') {
      $('#mdfr-txt').text('EDIT')
      $('#mdfr-act').val('update');
      $('#mdfr-in1').val(datas[0]);
      $('#mdfr-in2').val(datas[1]);
      $('#mdfr-in3').val(datas[2]);
      $('#mdfr-in4').prop('checked', (datas[3] == 'Y') ? true : false); 
    } else {
