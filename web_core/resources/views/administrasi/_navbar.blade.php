<nav class="main-header navbar-expand-sm navbar-dark navbar-custom-bg">
	<div class="container">
		<div class="row py-2">
			<div class="col-sm-8">
			...
			<div class="col-sm-4 d-flex justify-content-end">					
				...
				<ul class="navbar-nav navbar-no-expand order-2 ml-auto mt-2 mr-2" style="">
					<li class="nav-item dropdown float-right mt-1" style="">
						<a class="nav-link" data-toggle="dropdown" href="#" style="background-color:rgba(29, 81, 158, 0.65); opacity:0.6; border-radius:15px; height:40px; width:70px; padding: 0px; bottom: 3px">
								...
								<div class="card-body mb-0">
									<div class="d-flex">										
										...
										<div class="ml-2">
											...
											<span class="text-muted">Username : {{ $user_ses['username'] }}</span>
									...
									<p class="text-muted"><label style="width:60px"><i class="fas fa-house-user"></i>  Unit </label>: {{ $user_ses['active_role']['unit_kerja_nama'] }}</p>
									<div class="mt-2 d-flex justify-content-between">
										<a href="{{ url('/gate') }}" class="btn btn-outline-info"><i class="fab fa-buffer"></i> Daftar Modul</a>
										<button class="btn btn-outline-danger" data-toggle="modal" data-target="#modal-logout"><i class="fas fa-sign-out-alt"></i> Sign-out</button>
									</div>
								</div>
							</div>
						</div>
