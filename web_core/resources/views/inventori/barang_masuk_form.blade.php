...
<div class="content">
	<div class="container">
          ...
          <div class="d-flex justify-content-between align-items-center">
              ...
              <form id="tambah-form" method="post" action="{{ url($ctr_path.'/tambah') }}">
                @csrf
                  <div class="btn-group">
                      <button type="submit" name="action[]" value="valid" class="btn btn-primary btn-action">Submit</button>
                  </div>
              </form>
              
              <!-- Tombol lainnya di sebelah kanan -->
              <div class="btn-group">
                  <a href="{{ url('/inventori/barang-masuk') }}" class="btn btn-default"><i class="fas fa-arrow-left"></i> Kembali</a>
              ...
              <div class="modal-body" >
                <div class="row mb-2">
                  <label for="in1" class="col-lg-4 label-fr">Barang :</label>
                      <div class="col-lg-7">
                          <select name="in1" id="in1" class="form-control select2" style="width: 90%"></select>
                      </div>
                  </div>
                  <div class="row mb-2">
...
$(document).ready(function() {
    ...
    // $('#verif-form').on('submit', function(event) {
        ...
        // Make AJAX request
        $.ajax({
            url: $("#tambah-form").attr('action'), // URL dari form action
