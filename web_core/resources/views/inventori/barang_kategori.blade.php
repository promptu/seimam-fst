		...
		<form action="{{ url($ctr_path) }}" method="post" id="fr0" autocomplete="off">
			...
			<div class="card card-outline card-warning">
				<div class="card-body pb-2 row">
					<div class="col-lg-6">
						<div class="row mb-2">
							<label for="f1" class="col-lg-4 label-fr">Kategori :</label>
							<div class="col-lg-7">
	...
	<div class="modal-dialog">
      ...
      <form id="fr1" action="#" method="post" autocomplete="off">
        ...
        <div class="modal-body">
          <div class="row mb-2">
            <label for="mdfr-in1" class="col-lg-4 label-fr">Kategori Barang :</label>
...
<script>
  ...
  $('#fr1').submit(function(e){
    ...
    const datas = {'_token':token,'act':act,'in0':$('#mdfr-in0').val(),'in1':$('#mdfr-in1').val()};
    const bid = $('#mdfr-btn');
    const bval = bid.html();
    $.ajax({
