					...
					<table class="table table-sm table-striped table-hover no-wrap">
						...
						<tbody>
							...
							<tr>
								...
								<td>                  
                  @php
                    if ($r['ta_status_pengajuan_kode'] == 'draft' || $r['ta_status_pengajuan_kode'] == 'pengajuan') {
                      $str_pembimbing = '<span class="text-warning font-weight-bold">Pembimbing belum disetujui</span>';
                    } elseif ($r['ta_status_pengajuan_kode'] == 'disetujui') {
                      $str_pembimbing = '';
                      ...
                      $str_pembimbing = '<span class="text-danger font-weight-bold">-</span>';
                    }
                    echo $str_pembimbing;
                  @endphp
                </td>
