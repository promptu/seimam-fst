...
<div class="content">
	<div class="container">
        ...
        <div class="card-body pb-2 row">
					...
					<div class="col-lg-6">
						<div class="row mb-2">
							<label for="f4" class="col-lg-4 label-fr">Status Berkas :</label>
							<div class="col-lg-7">
								<select name="f4" id="f4" class="chform form-control">
									@foreach($cmb['status_berkas'] as $c) <option value="{{ $c['id'] }}" {{ ($c['id'] == $var['f4']) ? 'selected' : '' }}>{{ $c['val'] }}</option> @endforeach
								</select>
							</div>
						</div>
					</div>
			...
			<div class="card card-outline card-secondary">
				<div class="card-body p-0 table-responsive">
                  ...
                  @endphp
								...
								<td>{!! $mylib::status_berkas($r['status_berkas'],'lbl') !!}</td>
								<td>
                  @if ($r['is_edit'] == 'T')
